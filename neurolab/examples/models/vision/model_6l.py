...
class Model(nn.Module):
	...
	def __init__(self, input_shape=None, num_classes=10, dropout_p=0.):
		super().__init__()
		...
		self.fc6 = nn.Linear(4096, self.NUM_CLASSES) # 4096-dimensional input, 10-dimensional output (one per class)
