...
SEEDS1 = [0] #range(0, 5)
SEEDS2 = [300] #range(300, 305)
SEEDS3 = [400] #range(400, 405)
SEEDS4 = [500] #range(500, 505)
DATASEEDS = [200] #range(200, 205)
...
vgg = {lrn_rule + '_' + ds + da_names[da]: [] for lrn_rule in lrn_rules + ['none', 'all'] for ds in datasets for da in da_strategies}
...
for ds in datasets:
	for da in da_strategies:
		...
		for lrn_rule in lrn_rules:
			...
			vgg[lrn_rule + '_' + ds + da_names[da]] += [{P.KEY_STACK_CONFIG: 'configs.vision.vgg.smpleff_gdes_fc_on_hebb_vgg_ft[' + lrn_rule + '_' + ds + '_' + str(n) + da_names[da] + ']', P.KEY_STACK_SEEDS: SEEDS2, P.KEY_STACK_TOKENS: [str(i) for i in SEEDS1], P.KEY_STACK_DATASEEDS: DATASEEDS} for n in smpleff_regimes[ds]]
			vgg[lrn_rule + '_' + ds + da_names[da]] += [{P.KEY_STACK_CONFIG: 'configs.vision.vgg.smpleff_gdes_fc2_on_hebb_vgg_ft[' + lrn_rule + '_' + ds + '_' + str(n) + da_names[da] + ']', P.KEY_STACK_SEEDS: SEEDS2, P.KEY_STACK_TOKENS: [str(i) for i in SEEDS1], P.KEY_STACK_DATASEEDS: DATASEEDS} for n in smpleff_regimes[ds]]
			vgg[lrn_rule + '_' + ds + da_names[da]] += [{P.KEY_STACK_CONFIG: 'configs.vision.vgg.smpleff_prec_on_hebb_vgg_ft[' + lrn_rule + '_' + ds + '_' + str(n) + da_names[da] + ']', P.KEY_STACK_SEEDS: SEEDS3, P.KEY_STACK_TOKENS: [str(i) for i in SEEDS2], P.KEY_STACK_DATASEEDS: DATASEEDS} for n in smpleff_regimes[ds]]
			vgg['all' + '_' + ds + da_names[da]] += vgg[lrn_rule + '_' + ds + da_names[da]]
		vgg['none' + '_' + ds + da_names[da]] += [{P.KEY_STACK_CONFIG: 'configs.vision.vgg.gdes_fc_on_hebb_vgg_ft[' + 'none' + '_' + ds + da_names[da] + ']', P.KEY_STACK_SEEDS: SEEDS2, P.KEY_STACK_TOKENS: [str(i) for i in SEEDS1], P.KEY_STACK_DATASEEDS: DATASEEDS}]
		vgg['none' + '_' + ds + da_names[da]] += [{P.KEY_STACK_CONFIG: 'configs.vision.vgg.gdes_fc2_on_hebb_vgg_ft[' + 'none' + '_' + ds + da_names[da] + ']', P.KEY_STACK_SEEDS: SEEDS2, P.KEY_STACK_TOKENS: [str(i) for i in SEEDS1], P.KEY_STACK_DATASEEDS: DATASEEDS}]
		vgg['none' + '_' + ds + da_names[da]] += [{P.KEY_STACK_CONFIG: 'configs.vision.vgg.prec_on_hebb_vgg_ft[' + 'none' + '_' + ds + da_names[da] + ']', P.KEY_STACK_SEEDS: SEEDS3, P.KEY_STACK_TOKENS: [str(i) for i in SEEDS2], P.KEY_STACK_DATASEEDS: DATASEEDS}]
		vgg['none' + '_' + ds + da_names[da]] += [{P.KEY_STACK_CONFIG: 'configs.vision.vgg.smpleff_gdes_fc_on_hebb_vgg_ft[' + 'none' + '_' + ds + '_' + str(n) + da_names[da] + ']', P.KEY_STACK_SEEDS: SEEDS2, P.KEY_STACK_TOKENS: [str(i) for i in SEEDS1], P.KEY_STACK_DATASEEDS: DATASEEDS} for n in smpleff_regimes[ds]]
		vgg['none' + '_' + ds + da_names[da]] += [{P.KEY_STACK_CONFIG: 'configs.vision.vgg.smpleff_gdes_fc2_on_hebb_vgg_ft[' + 'none' + '_' + ds + '_' + str(n) + da_names[da] + ']', P.KEY_STACK_SEEDS: SEEDS2, P.KEY_STACK_TOKENS: [str(i) for i in SEEDS1], P.KEY_STACK_DATASEEDS: DATASEEDS} for n in smpleff_regimes[ds]]
		vgg['none' + '_' + ds + da_names[da]] += [{P.KEY_STACK_CONFIG: 'configs.vision.vgg.smpleff_prec_on_hebb_vgg_ft[' + 'none' + '_' + ds + '_' + str(n) + da_names[da] + ']', P.KEY_STACK_SEEDS: SEEDS3, P.KEY_STACK_TOKENS: [str(i) for i in SEEDS2], P.KEY_STACK_DATASEEDS: DATASEEDS} for n in smpleff_regimes[ds]]
		vgg['all' + '_' + ds + da_names[da]] += vgg['none' + '_' + ds + da_names[da]]
