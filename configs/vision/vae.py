...
for ds in datasets:
	for da in [False, True]:
		config_base_vae[ds + ('_da' if da else '')] = {
		...
		for l in range(1, num_layers[ds]):
			gdes_fc_on_vae_layer[str(l) + '_' + ds + ('_da' if da else '')] = {
			...
			hebb_fc_on_vae_layer[str(l) + '_' + ds + ('_da' if da else '')] = {
				P.KEY_EXPERIMENT: 'neurolab.experiment.VisionExperiment',
			...
			hebb_fc_on_vae_layer_ft[str(l) + '_' + ds + ('_da' if da else '')] = {
				P.KEY_EXPERIMENT: 'neurolab.experiment.VisionExperiment',
				P.KEY_NET_MODULES: 'models.hebb.fc.Net',
				P.KEY_NET_OUTPUTS: 'fc',
				P.KEY_DATA_MANAGER: 'neurolab.data.' + data_managers[ds],
			    ...
			    P.KEY_LEARNING_RATE: 1e-3,
				P.KEY_PRE_NET_MODULES: ['models.gdes.vae_' + str(num_layers[ds]) + 'l.Net'],
				P.KEY_PRE_NET_MDL_PATHS: [P.PROJECT_ROOT + '/results/configs/vision/vae/gdes_fc_on_vae_layer_ft[' + str(l) + '_' + ds + ('_da' if da else '') + ']/iter' + P.STR_TOKEN + '/models/model0.pt'],
				P.KEY_PRE_NET_OUTPUTS: ['bn' + str(l)],
			}
			
			gdes_fc2_on_vae_layer[str(l) + '_' + ds + ('_da' if da else '')] = {
				P.KEY_EXPERIMENT: 'neurolab.experiment.VisionExperiment',
			...
			gdes_fc2_on_vae_layer_ft[str(l) + '_' + ds + ('_da' if da else '')] = {
				P.KEY_EXPERIMENT: 'neurolab.experiment.VisionExperiment',
			...
			for lrn_rule in lrn_rules:
				hebb_fc2_on_vae_layer[str(l) + '_' + lrn_rule + '_' + ds + ('_da' if da else '')] = {
					P.KEY_EXPERIMENT: 'neurolab.experiment.VisionExperiment',
			...
			for lrn_rule in lrn_rules:
				hebb_fc2_on_vae_layer_ft[str(l) + '_' + lrn_rule + '_' + ds + ('_da' if da else '')] = {
					P.KEY_EXPERIMENT: 'neurolab.experiment.VisionExperiment',
					P.KEY_NET_MODULES: 'models.hebb.fc2.Net',
					P.KEY_NET_OUTPUTS: 'fc2',
					P.KEY_DATA_MANAGER: 'neurolab.data.' + data_managers[ds],
			...
			knn_on_vae_layer[str(l) + '_' + ds + ('_da' if da else '')] = {
				P.KEY_EXPERIMENT: 'neurolab.experiment.VisionExperiment',
				P.KEY_NET_MODULES: 'neurolab.model.skclassif.KNNClassifier',
				P.KEY_NET_OUTPUTS: 'clf',
				P.KEY_DATA_MANAGER: 'neurolab.data.' + data_managers[ds],
			...
			knn_on_vae_layer_ft[str(l) + '_' + ds + ('_da' if da else '')] = {
				P.KEY_EXPERIMENT: 'neurolab.experiment.VisionExperiment',
				P.KEY_NET_MODULES: 'neurolab.model.skclassif.KNNClassifier',
				P.KEY_NET_OUTPUTS: 'clf',
				P.KEY_DATA_MANAGER: 'neurolab.data.' + data_managers[ds],
			...
			svm_on_vae_layer[str(l) + '_' + ds + ('_da' if da else '')] = {
				P.KEY_EXPERIMENT: 'neurolab.experiment.VisionExperiment',
			...
			svm_on_vae_layer_ft[str(l) + '_' + ds + ('_da' if da else '')] = {
				P.KEY_EXPERIMENT: 'neurolab.experiment.VisionExperiment',
				P.KEY_NET_MODULES: 'neurolab.model.skclassif.SVMClassifier',
				P.KEY_NET_OUTPUTS: 'clf',
				P.KEY_DATA_MANAGER: 'neurolab.data.' + data_managers[ds],
