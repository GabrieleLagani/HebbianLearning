...
for ds in datasets:
	for da in da_strategies:
		config_base_vae[ds + da_names[da]] = {
		...
		for l in range(1, num_layers[ds]):
			gdes_fc_on_vae_layer[str(l) + '_' + ds + da_names[da]] = {
			...
			gdes_fc_on_vae_layer_ft[str(l) + '_' + ds + da_names[da]] = {
				P.KEY_EXPERIMENT: 'neurolab.experiment.VisionExperiment',
			...
			hebb_fc_on_vae_layer[str(l) + '_' + ds + da_names[da]] = {
				P.KEY_EXPERIMENT: 'neurolab.experiment.VisionExperiment',
			...
			hebb_fc_on_vae_layer_ft[str(l) + '_' + ds + da_names[da]] = {
				P.KEY_EXPERIMENT: 'neurolab.experiment.VisionExperiment',
				P.KEY_NET_MODULES: 'models.hebb.fc.Net',
				P.KEY_NET_OUTPUTS: 'fc',
				P.KEY_DATA_MANAGER: data_managers[ds],
			...
			prec_on_vae_layer[str(l) + '_' + ds + da_names[da]] = {
				P.KEY_EXPERIMENT: 'neurolab.experiment.VisionExperiment',
			...
			knn_on_vae_layer_ft[str(l) + '_' + ds + da_names[da]] = {
				P.KEY_EXPERIMENT: 'neurolab.experiment.VisionExperiment',
				P.KEY_NET_MODULES: 'neurolab.model.skclassif.KNNClassifier',
				P.KEY_NET_OUTPUTS: 'clf',
				P.KEY_DATA_MANAGER: data_managers[ds],
			...
			svm_on_vae_layer[str(l) + '_' + ds + da_names[da]] = {
				P.KEY_EXPERIMENT: 'neurolab.experiment.VisionExperiment',
			...
			svm_on_vae_layer_ft[str(l) + '_' + ds + da_names[da]] = {
				P.KEY_EXPERIMENT: 'neurolab.experiment.VisionExperiment',
				P.KEY_NET_MODULES: 'neurolab.model.skclassif.SVMClassifier',
				P.KEY_NET_OUTPUTS: 'clf',
				P.KEY_DATA_MANAGER: data_managers[ds],
