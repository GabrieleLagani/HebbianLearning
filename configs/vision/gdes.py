	...
	for da in [False, True]:
		...
		for l in range(1, num_layers[ds]):
			...
			gdes_fc_on_gdes_layer_ft[str(l) + '_' + ds + ('_da' if da else '')] = {
				...
				P.KEY_NET_MDL_PATHS: [P.PROJECT_ROOT + '/results/configs/vision/gdes/config_base_gdes[' + ds + ('_da' if da else '') + ']/iter' + P.STR_TOKEN + '/models/model0.pt'],
			...
			hebb_fc_on_gdes_layer_ft[str(l) + '_' + ds + ('_da' if da else '')] = {
			    ...
			    P.KEY_LEARNING_RATE: 1e-3,
				P.KEY_PRE_NET_MODULES: ['models.gdes.model_' + str(num_layers[ds]) + 'l.Net'],
				P.KEY_PRE_NET_MDL_PATHS: [P.PROJECT_ROOT + '/results/configs/vision/gdes/gdes_fc_on_gdes_layer_ft[' + str(l) + '_' + ds + ('_da' if da else '') + ']/iter' + P.STR_TOKEN + '/models/model0.pt'],
				P.KEY_PRE_NET_OUTPUTS: ['bn' + str(l)],
			}
			...
			gdes_fc2_on_gdes_layer_ft[str(l) + '_' + ds + ('_da' if da else '')] = {
				P.KEY_EXPERIMENT: 'neurolab.experiment.VisionExperiment',
				P.KEY_NET_MODULES: ['models.gdes.model_6l.Net', 'models.gdes.fc2.Net'],
				P.KEY_NET_MDL_PATHS: [P.PROJECT_ROOT + '/results/configs/vision/gdes/config_base_gdes[' + ds + ('_da' if da else '') + ']/iter' + P.STR_TOKEN + '/models/model0.pt'],
			...
			for lrn_rule in lrn_rules:
				hebb_fc2_on_gdes_layer_ft[str(l) + '_' + lrn_rule + '_' + ds + ('_da' if da else '')] = {
					P.KEY_EXPERIMENT: 'neurolab.experiment.VisionExperiment',
					P.KEY_NET_MODULES: 'models.hebb.fc2.Net',
					P.KEY_NET_OUTPUTS: 'fc2',
					P.KEY_DATA_MANAGER: 'neurolab.data.' + data_managers[ds],
