	...
	for da in da_strategies:
		...
		for l in range(1, num_layers[ds]):
			...
			gdes_fc_on_gdes_layer_ft[str(l) + '_' + ds + da_names[da]] = {
				...
				P.KEY_NET_MDL_PATHS: [P.PROJECT_ROOT + '/results/configs/vision/gdes/config_base_gdes[' + ds + da_names[da] + ']/iter' + P.STR_TOKEN + '/models/model0.pt'],
			...
			hebb_fc_on_gdes_layer_ft[str(l) + '_' + ds + da_names[da]] = {
			    ...
			    P.KEY_LEARNING_RATE: 1e-3,
				P.KEY_PRE_NET_MODULES: ['models.gdes.model_' + str(num_layers[ds]) + 'l.Net'],
				P.KEY_PRE_NET_MDL_PATHS: [P.PROJECT_ROOT + '/results/configs/vision/gdes/gdes_fc_on_gdes_layer_ft[' + str(l) + '_' + ds + da_names[da] + ']/iter' + P.STR_TOKEN + '/models/model0.pt'],
				P.KEY_PRE_NET_OUTPUTS: ['bn' + str(l)],
			}
			
			gdes_fc2_on_gdes_layer[str(l) + '_' + ds + da_names[da]] = {
				P.KEY_EXPERIMENT: 'neurolab.experiment.VisionExperiment',
				P.KEY_NET_MODULES: 'models.gdes.fc2.Net', 'mdl1:' + PP.KEY_NUM_HIDDEN: 256, 'mdl1:' + PP.KEY_NUM_HIDDEN: 256,
			...
			prec_on_gdes_layer[str(l) + '_' + ds + da_names[da]] = {
				...
				P.KEY_PRE_NET_MDL_PATHS: [P.PROJECT_ROOT + '/results/configs/vision/gdes/config_base_gdes[' + ds + da_names[da] + ']/iter' + P.STR_TOKEN + '/models/model0.pt',
				                          P.PROJECT_ROOT + '/results/configs/vision/gdes/gdes_fc2_on_gdes_layer[' + str(l) + '_' + ds + da_names[da] + ']/iter' + P.STR_TOKEN + '/models/model0.pt'],
			...
			prec_on_gdes_layer_ft[str(l) + '_' + ds + da_names[da]] = {
				...
				P.KEY_RETR_K: retr_k[ds],
				P.KEY_PRE_NET_MODULES: ['models.gdes.model_' + str(num_layers[ds]) + 'l.Net', 'models.gdes.fc2.Net'], 'mdl1:' + PP.KEY_NUM_HIDDEN: 256,
				P.KEY_PRE_NET_MDL_PATHS: [P.PROJECT_ROOT + '/results/configs/vision/gdes/gdes_fc2_on_gdes_layer_ft[' + str(l) + '_' + ds + da_names[da] + ']/iter' + P.STR_TOKEN + '/models/model0.pt',
				                          P.PROJECT_ROOT + '/results/configs/vision/gdes/gdes_fc2_on_gdes_layer_ft[' + str(l) + '_' + ds + da_names[da] + ']/iter' + P.STR_TOKEN + '/models/model1.pt'],
				P.KEY_PRE_NET_OUTPUTS: ['bn' + str(l), 'bn1'],
			}
